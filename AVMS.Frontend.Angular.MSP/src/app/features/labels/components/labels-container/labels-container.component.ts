...
export class LabelsContainerComponent implements OnInit, OnDestroy {
  ...
  //     portal: new ComponentPortal(LabelDetailsComponent)
  //   };
  ...
  //           return this.httpService.editLabel(row.label, labels).pipe(
  //             catchError(err => {
  //               isError = true;
  ...
  //         data.secondaryButtonText = '';
  //         data.cancelButtonText = '';
  //         data.confirmTitle = 'Label successfully Edited!';
  //         data.confirmMessage = 'The ' + this.labelsService.label.name + ' was successfully created and applied on the ' + this.labelsService.label.resourcesNames + ' resources';
  //         const finishDialog = this.dialog.open<ModalDialogResponseOptions>(ModalDialogComponent, {
  //           width: '800px',
  //           data: data,
  //         });
  ...
  addLabel(): void {
    ...
    //       ) {
    //         const labels = this.labelsService.getSelectedLabels()
    //         return this.httpService.addLabel(labels).pipe(
    //           catchError(err => {
    //             isError = true;
    //             return of(err.error as ApiError);
    //           }),
    ...
    //       data.secondaryButtonText = '';
    //       data.cancelButtonText = '';
    //       data.confirmTitle = 'Label successfully created!';
    //       data.confirmMessage = 'The ' + this.labelsService.label.name + ' was successfully created and applied on the ' + this.labelsService.label.resourcesNames + ' resources';
    //       const finishDialog = this.dialog.open<ModalDialogResponseOptions>(ModalDialogComponent, {
    //         width: '800px',
    //         data: data,
