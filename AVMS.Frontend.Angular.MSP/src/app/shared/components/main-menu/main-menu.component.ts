...
export class MainMenuComponent implements OnInit {
  ...
  navigationMenu(menuItem: string): void {
 ...
 toggleMenu(){
  ...
  ngOnInit(): void {
   ...
   const avatar_img = localStorage.getItem('avatar_img');
   if (first_name && last_name && avatar_img) {
    this.myProfile.first_name = first_name;
    this.myProfile.last_name = last_name;
    this.myProfile.avatar = avatar_img;
  } else {
    this.getMyProfile();
  }
  }
  ...
  this.userService.getMyProfile().subscribe(result => {
      ...
      localStorage.setItem('first_name', this.myProfile.first_name);
      localStorage.setItem('last_name', this.myProfile.last_name);
      localStorage.setItem('avatar_img', this.myProfile.avatar);  
    });
  }
