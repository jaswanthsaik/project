...
import { manageByExceptions } from './features/analytics/manageByExceptions.component';
import { CPUusage } from './features/analytics/CPUusage.component';
import { Recommendations } from './features/analytics/Recommendations.component';
import { Financial } from './features/analytics/Financial.component';
...
const routes: Routes = [
  ...
  {path: 'visual-analytics', component: QlikVisualizationComponent},
  {path: 'unauthorized', component: UnathorizedPageComponent},
  {path: 'allow-cookies', component: AllowCookiesComponent},
  { path: "analytics.", component: manageByExceptions },
  { path: "analytics..", component: CPUusage },
  { path: "analytics...", component: Recommendations },
  { path: "analytics....", component: Financial },
];
