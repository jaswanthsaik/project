...
export class AccountsContainerComponent implements OnInit, OnDestroy{
  ...
  addAccountDialogRef!: MatDialogRef<AddAccountComponent>;
  editAccountDialogRef!: MatDialogRef<AddAccountComponent>;
  ...
  addAccount() {
    ...
    this.addAccountDialogRef = this.dialog1.open(AddAccountComponent, {
      width: '672px',
      height: 'auto',
    });
  }
